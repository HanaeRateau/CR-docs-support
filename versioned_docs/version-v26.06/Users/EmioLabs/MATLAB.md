...
Pilot Emio from MATLAB, and create your own teaching material. Thanks to the [UDP bridge](../../../Developers/emio-api/#startudp) of the [Emio API](../../../Developers/emio-api/) and the [MATLAB.Emio](https://github.com/SofaComplianceRobotics/MATLAB.Emio) GitHub repository you can use the _Emio Communication UDP block_ in SimuLink and send commands to Emio, and also retrieve markers position, directly from MATLAB. 
